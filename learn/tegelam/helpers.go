...
func NewInlineQueryResultArticle(id, title, messageText, url string) InlineQueryResultArticle {
...
func NewInlineQueryResultPhoto(id, url, thuburl string) InlineQueryResultPhoto {
...
func NewInlineQueryResultVideo(id, url, thumburl, title string) InlineQueryResultVideo {
...
func NewHideKeyboard(selective bool) ReplyKeyboardHide {
	fmt.Println("NewHideKeyboard is deprecated, please use NewRemoveKeyboard")
...
func NewJumpHTMLString(Url, message string) string {
	return fmt.Sprintf("<a href='%s'>%s</a>", Url, message)
}
...
b code 多行等宽
*/
func NewFontStyle(message, style string) string {
	result := message
	switch style {
	case "b":
		result = fmt.Sprintf("<b>%s</b>", message)
	case "i":
		result = fmt.Sprintf("<i>%s</i> ", message)
	case "u":
		result = fmt.Sprintf("<u>%s</u>", message)
	case "s":
		result = fmt.Sprintf("<s>%s</s>", message)
	case "code":
		result = fmt.Sprintf("<code>%s</code>", message)
	}
	return result
}
